class RotaController < ApplicationController
  ...
  def assign
    ...
    redirect_to rotum_duties_url(@rotum), notice: "Duties assigned"
  end
  ...
  def unassign
    ...
    redirect_to rotum_duties_url(@rotum), notice: "Duties unassigned"
  end
  ...
  def publish
    ...
    redirect_to rotum_duties_url(@rotum), notice: "Rota published"
  end
  ...
  def unpublish
    ...
    redirect_to rotum_duties_url(@rotum), notice: "Rota unpublished"
  end
end
